...
import wizardStyle from "assets/jss/hhi-js-styles/components/wizardStyle.js";
...
class Wizard extends React.Component {
    ...
    render() {
        ...
        return ( <
            ...
            /ul> <
            div className = { classes.movingTab + " " + classes[color] }
            ...
            div className = { classes.left } > {
                this.state.previousButton ? ( <
                    Button className = { this.props.previousButtonClasses }
                    onClick = {
