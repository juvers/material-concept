...
import styles from "assets/jss/hhi-js-styles/customSelectStyle.js";
            ...
            headerGroups.map(headerGroup => ( <
                ...
                className = "rt-tr" > {
                    headerGroup.headers.map((column, key) => ( <
                        ...
                        <
                        div className = "rt-resizable-header-content" > { column.render("Header") } <
                        /div> { /* Render the columns filter UI */ } <
                        div > {
                    ...
                    } >
                    {
                        row.cells.map(cell => {
                            return ( <
                                ...
                                className = "rt-td" > { cell.render("Cell") } <
                                /td>
                            );
                        })
                    } <
